...
class StateController {
    ...
    var userRankings: RankingsModel = .init(rank: 1, wp: 18, ap: 64, sp: 793, wins: 8, losses: 1, ties: 0, highScore: 113, average: 113.44, total: 1021)
    var focusedCompetitionID: Int? = 52110
    var watchlist: [TeamInfoModel] = []
}
